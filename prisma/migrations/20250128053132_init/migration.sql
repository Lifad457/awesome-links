/*
  ...
  - The primary key for the `_LinkToUser` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "_LinkToUser" DROP CONSTRAINT "_LinkToUser_AB_pkey",
DROP COLUMN "A",
ADD COLUMN     "A" INTEGER NOT NULL,
DROP COLUMN "B",
ADD COLUMN     "B" INTEGER NOT NULL,
ADD CONSTRAINT "_LinkToUser_AB_pkey" PRIMARY KEY ("A", "B");
